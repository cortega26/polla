...
def test_multi_source_majority_vote(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    entries = [
        {"fuente": "s1", "montos": {"Loto": 1_000_000_000}, "sorteo": 1, "fecha": "2025-01-01"},
        {"fuente": "s2", "montos": {"Loto": 1_000_000_000}, "sorteo": 1, "fecha": "2025-01-01"},
        {"fuente": "s3", "montos": {"Loto": 3_000_000_000}, "sorteo": 1, "fecha": "2025-01-01"},
    ]
    ...
    assert norm["pozos_proximo"]["Loto"] == 1_000_000_000
